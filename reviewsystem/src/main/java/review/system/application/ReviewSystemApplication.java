package review.system.application;
...
public class ReviewSystemApplication extends Application<ReviewSystemConfiguration> {
    ...
    public static void main(String[] args) throws Exception {
	 ...
	 @Override
	    ...
	    @Override
	    public void run(ReviewSystemConfiguration configuration, Environment environment) throws Exception {
	        JerseyEnvironment je = environment.jersey();
	        ResourceContainer resourceContainer = applicationContext.getBean(ResourceContainer.class);
